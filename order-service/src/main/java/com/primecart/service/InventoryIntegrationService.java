...
public class InventoryIntegrationService {
    ...
    public void reserveStock(ReserveStockRequest request) {
        ...
        log.info(
                "Inventory reserved successfully. productId={}, quantity={}",
                request.getProductId(),
                request.getQuantity()
        );
    }
    ...
    public void releaseStock(ReserveStockRequest request) {
        ...
        log.info(
                "Calling Inventory Service to release stock. productId={}, quantity={}",
                request.getProductId(),
                request.getQuantity()
        );
        ...
        log.info(
                "Inventory released successfully. productId={}, quantity={}",
                request.getProductId(),
                request.getQuantity()
        );
    }
    ...
    public void confirmStock(ReserveStockRequest request) {
        ...
        log.info(
                "Calling Inventory Service to confirm stock. productId={}, quantity={}",
                request.getProductId(),
                request.getQuantity()
        );
        ...
        log.info(
                "Inventory confirmed successfully. productId={}, quantity={}",
                request.getProductId(),
                request.getQuantity()
        );
    }
    ...
    private void reserveStockFallback(
        ...
        if (throwable instanceof BulkheadFullException) {
            ...
            log.warn(
                    "Inventory Bulkhead is full. Call rejected. productId={}",
                    request.getProductId()
            );
        ...
        if (throwable instanceof CallNotPermittedException) {
            ...
            log.warn(
                    "Inventory Circuit Breaker is open. productId={}",
                    request.getProductId()
            );
    ...
    private void releaseStockFallback(
            ReserveStockRequest request,
            Throwable throwable) {

        log.error(
                "Inventory release failed. productId={}, quantity={}, reason={}",
                request.getProductId(),
                request.getQuantity(),
                throwable.getMessage(),
                throwable
    ...
    private void confirmStockFallback(
            ReserveStockRequest request,
            Throwable throwable) {

        log.error(
                "Inventory confirmation failed. productId={}, quantity={}, reason={}",
                request.getProductId(),
                request.getQuantity(),
                throwable.getMessage(),
                throwable
        ...
        throw new InventoryReservationException(
                "Inventory Service is temporarily unavailable. "
                        + "Unable to confirm inventory for product "
                        + request.getProductId()
        );
    }
}
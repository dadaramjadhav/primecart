...
public class OrderController {
    ...
    public ResponseEntity<OrderResponse> getOrderByOrderNumber(
        ...
        log.info("GET /api/orders/order-number/{} - Get order by order number request received", orderNumber);
    ...
    public ResponseEntity<List<OrderResponse>> getOrdersByCustomerId(
        ...
        log.info("GET /api/orders/customer/{} - Get orders by customer request received", customerId);
    ...
    public ResponseEntity<Page<OrderResponse>> getOrdersByStatus(
        ...
        log.info("GET /api/orders/status/{} - Get orders by status request received", status);
    ...
    public ResponseEntity<OrderResponse> paymentFailed(
        ...
        log.info("PUT /api/orders/{}/payment-failed - Payment failed event received", orderId);
    ...
    public ResponseEntity<OrderResponse> paymentSuccess(
        ...
        log.info("PUT /api/orders/{}/payment-success - Payment success event received", orderId);

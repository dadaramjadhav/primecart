...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
        ...
        log.warn("Customer profile database conflict: method={}, path={}", request.getMethod(), request.getRequestURI());

        return buildResponse(HttpStatus.CONFLICT, "CUSTOMER_PROFILE_CONFLICT", "The customer profile conflicts with existing data",
                             List.of(), request);
    }
    ...
    public ResponseEntity<ErrorResponse> handleCustomerProfileNotFound(
            CustomerProfileNotFoundException exception,
            HttpServletRequest request
    ) {
        return buildResponse(HttpStatus.NOT_FOUND, "CUSTOMER_PROFILE_NOT_FOUND", exception.getMessage(), List.of(), request);
    }
